...
const TwitterButton = ({data}) => (
  <TwitterWrapper>
    <svg width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="twitterTitle">
      <title id="twitterTitle">Share on Twitter</title>
      <a target="_blank" xlinkHref={`http://twitter.com/home?status="${encodeURIComponent(data)}" — Unknown via ${encodeURIComponent('https://confessions.tech')}`}>
